...
### ⬇ [**PA Toolbox v0.1.0 をダウンロード（APK・2.2MB）**](https://github.com/minetan1229/pa_system_app/raw/main/dist/pa-toolbox-v0.1.0.apk)

Android 8.0（API 26）以降。**35ツールすべてが使えます。**
...
## 現在の状態: **35ツールすべて実装済み**（Phase 5 の課金・法務のみ未着手）
